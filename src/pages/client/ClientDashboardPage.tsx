    ...
    <div className="flex-1 overflow-y-auto p-4 md:p-6 fade-in w-full">
      ...
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="relative">
          <button
            ...
            className="relative w-10 h-10 rounded-xl bg-[#12101A] border border-[#1E1C2A] flex items-center justify-center text-[#6B6B80] hover:text-white hover:border-[#C026A8]/40 transition-all"
          >
            <Bell size={17} />
            {unreadCount > 0 && (
          ...
          {showNotifications && (
            <div className="absolute right-0 top-12 w-80 bg-[#12101A] border border-[#1E1C2A] rounded-2xl shadow-2xl shadow-black/50 z-50 overflow-hidden">
              <div className="flex items-center justify-between px-4 py-3 border-b border-[#1E1C2A]">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={() => setShowNotifications(false)} className="text-[#6B6B80] hover:text-white">
                    <X size={14} />
                  </button>
                </div>
              </div>
                ...
                {notifications.length === 0 ? (
                  ...
                  notifications.slice(0, 8).map(notif => (
                    <button
                      ...
                      className={`w-full flex items-start gap-3 px-4 py-3 text-left border-b border-[#1E1C2A] last:border-0 transition-colors hover:bg-white/3 ${!notif.is_read ? 'bg-[#C026A8]/5' : ''}`}
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1.5">
                          <p className={`text-xs font-semibold truncate ${!notif.is_read ? 'text-white' : 'text-white/70'}`}>
                            {notif.title}
                          </p>
                          {!notif.is_read && (
      ...
      {project && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
          {/* Progreso */}
          <div className="bg-[#12101A] border border-[#1E1C2A] rounded-xl p-3">
      ...
      {project && (
        <div className="rounded-2xl border border-[#1E1C2E] bg-[#111019] p-4 mb-4">
        ...
        <div className="rounded-2xl border border-[#1E1C2E] bg-[#111019] p-4 mb-4">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm font-semibold text-white">Últimos entregables</p>
            </div>
            <button
          ...
          <div className="space-y-2">
            {deliverables.slice(0, 3).map(item => (
              <div key={item.id} className="flex items-center gap-3 py-1.5">
                <div className="w-7 h-7 rounded-lg bg-[#1A1825] border border-[#1E1C2A] flex items-center justify-center flex-shrink-0">
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <button
          ...
          style={{ background: 'linear-gradient(135deg, #1A0E2A 0%, #111019 100%)' }}
        >
          ...
          <p className="text-sm font-bold text-white">Gestionar a {agentName}</p>
        ...
        <button
          ...
          style={{ background: 'linear-gradient(135deg, #0D1320 0%, #111019 100%)' }}
        >
          ...
          <p className="text-sm font-bold text-white">Hablar con tu gestor</p>
        ...
        <div className="rounded-2xl border border-[#1E1C2E] bg-[#111019] p-4 mb-4">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm font-semibold text-white">Tareas pendientes</p>
            </div>
